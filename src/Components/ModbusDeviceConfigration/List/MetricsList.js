...
const fields = [
  ...
  "max_alarm",
  {
    key: "Edit",
    //label: "Action",
    _style: { width: "1%" ,displayContent:'flex'},
    sorter: false,
    filter: false,
  },
  {
...
const MatricsList = (props) => {
  ...
  useEffect(() => {
    axios({
      method: "GET",
      url: `/modbus/metrics?device_code=${device_code}`,
    }).then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios({
      method: "PUT",
      url: `/modbus/metrics?device_code=${device_code}&unique_tag=${unique_tag}`,
      data: utag,
    })
              ...
              <CCollapse show={details.includes(index)}>
                <CCardBody>
                  ...
                  >
                    ...
                    <CButton id={index} type="submit" size="sm" color="primary">
