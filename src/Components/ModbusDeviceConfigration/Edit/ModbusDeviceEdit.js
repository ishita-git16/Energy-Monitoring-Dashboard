...
const ModbusDeviceEdit = (props) => {
  ...
  useEffect(() => {
    const res = axios({
      method: "GET",
      url: `/modbus/device?device_code=${device_code}`,
    }).then((res) => {
      setMData(res.data);
  ...
  const handleSubmit = (event) => {
    const mydata = {
      ...
      alarm_config: {
        enable: alaramdata.enable,
        type: alaramdata.type,
        details: {},
      },
    };
        ...
        <CCol xs="12" md="12" className="mb-4">
          <CCard>
            <CCardHeader>
              ...
              <h6>
                Sync Datetime : <strong>{mdata.syncdatetime}</strong>{" "}
              </h6>
            </CCardHeader>
            <CCardBody>
              <CTabs>
                <CNav variant="tabs">
                  <CNavItem>
                    <CNavLink>Device Details</CNavLink>
                  </CNavItem>
                  {/* <CNavItem>
                    <CNavLink>
                    Alaram Config
                  ...
                  <CNavItem>
                    <CNavLink>Metrics Details</CNavLink>
                  </CNavItem>
                </CNav>
                <CTabContent>
                  <CTabPane>
                      ...
                      >
                        ...
                        <CFormGroup row>
                          ...
                          <CCol xs="8" md="3">
                            <CInput
                              name="poll_interval"
                              value={mdata.poll_interval}
                              onChange={onChangeHandler}
                            />
                            <CLabel>Seconds</CLabel>
                          </CCol>
                        </CFormGroup>
                        <CButton
                          block
                        ...
                        <CCollapse show={accordion === 2}>
                          <CCardBody>
                            ...
                            <CFormGroup row>
                              ...
                              <CCol xs="8" md="3">
                                <CInput
                                  name="batch_retry_times"
                                  value={mdata.batch_retry_times}
                                  onChange={onChangeHandler}
                                />
                              </CCol>
                            </CFormGroup>
                        ...
                        <CButton
                          ...
                          className="text-left m-0 p-0"
                          onClick={() =>
                            setAccordion(accordion === 3 ? null : 3)
                          }
                        >
                            ...
                            <CFormGroup row>
                              ...
                              <CCol xs="8" md="3">
                                <CSwitch
                                  name="enable"
                                  onChange={(event) => {
                                    handleAlaramSwitchChange(event);
                                  }}
