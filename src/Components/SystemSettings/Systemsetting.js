...
import {
  ...
  CTabPane,
  CCard,
  CCardBody, CInputRadio,
  CTabs,
  CCardHeader, CContainer, CForm, CFormGroup, CLabel, CInput, CFormText, CSwitch, CButton,
} from '@coreui/react'
                    ...
                    <CCardBody>
                      <CForm onSubmit={handleSubmit} className="form-horizontal">
                        ...
                        <CFormGroup row>
                          ...
                          <CCol xs="12" md="9">
                            <CInput id="text-input" value={data.ip_address} name="ip_address" onChange={onChangeHandler} />
                          </CCol>
                        </CFormGroup>
                        <CFormGroup row>
                          <CCol md="3">
                          ...
                          <CCol xs="12" md="9">
                            <CInput id="text-input" value={data.subnet_mask} name="subnet_mask" onChange={onChangeHandler} />
                        ...
                        <CFormGroup row>
                          ...
                          <CCol xs="12" md="9">
                            <CInput id="text-input" value={data.default_gateway} name="default_gateway" onChange={onChangeHandler} />
                            {/* <CFormText>This is a help text</CFormText> */}
                          </CCol>
                        </CFormGroup>
                        <CFormGroup row>
                          ...
                          <CCol xs="12" md="9">
                            <CInput id="text-input" value={data.dns_server1} name="dns_server1" onChange={onChangeHandler} />
                            {/* <CFormText>This is a help text</CFormText> */}
                          </CCol>
                        </CFormGroup>
                        <CFormGroup row>
                          ...
                          <CCol xs="12" md="9">
                            <CInput id="text-input" value={data.dns_server2} name="dns_server2" onChange={onChangeHandler} />
                            {/* <CFormText>This is a help text</CFormText> */}
                          </CCol>
                        </CFormGroup>
